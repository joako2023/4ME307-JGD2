...
export class  AlimentosSugeridosService extends CrudService<any, any> {
  constructor(
    ...
    super(http, utils, {
      ...
      urlDelete: '/alimentos-sugeridos',
      urlGet: '/alimentos-sugeridos',
      urlPut: '/alimentos-sugeridos',
      urlPost: '/alimentos-sugeridos',
      urlGetInfinite: '',
      ...
      keyLocalStorageList: 'LIST_ALIMENTOS',
      keyLocalStorageSelected: 'ALIMENTOS_SELECTED'
    });
    super.get();
  }
}